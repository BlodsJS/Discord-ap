...
class utilsPort:
	def __init__(self):
		...
		self.assets = {
            ...
            'theme': os.path.join(self.base_path,'assets/themes/'),
            'houses': {
                'Leonipards': os.path.join(self.base_path,'assets/arms/leonipards.png'),
                'Synexa': os.path.join(self.base_path, 'assets/arms/synexa.png'),
                'Corbusier': os.path.join(self.base_path, 'assets/arms/corbusier.png'),
                'Vildjharta': os.path.join(self.base_path, 'assets/arms/vildjharta.png'),
                'cidadao': os.path.join(self.base_path, 'assets/arms/cidadao.png'),
                'imperador': os.path.join(self.base_path,"assets/arms/imperador.png")
                
            },
            'model': os.path.join(self.base_path,'assets/bei_model.png')
        }
		self.fonts = {
